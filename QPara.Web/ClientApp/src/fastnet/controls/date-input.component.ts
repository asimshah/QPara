...
import { Component, forwardRef, Input, EventEmitter, Output, ViewEncapsulation, OnDestroy, AfterViewInit, OnInit, ViewChild, ElementRef } from '@angular/core';
...
export class DateInputControl extends InputControlBase implements OnInit, AfterViewInit, OnDestroy {
  ...
  //@ViewChild('as1', { static: false }) as1: ElementRef;
  ...
  ngOnInit() {
    this.showCalendar = this.showInputBox === false ? true : true;
  ...
  private openCalendar() {
    ...
    //setTimeout(() => {
    //  let x: any = document.getElementsByClassName('calendar')[0];
    //  x.focus();
    //}, 10);

    //this.as1.nativeElement.focus();
